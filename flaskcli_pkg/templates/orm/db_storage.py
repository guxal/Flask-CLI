    ...
    def __init__(self):
        ...
        self.__engine = create_engine(
            'mysql+mysqldb://{}:{}@{}/{}'.format(
                os.environ.get('<[app]>_MYSQL_USER'),
                os.environ.get('<[app]>_MYSQL_PWD'),
                os.environ.get('<[app]>_MYSQL_HOST'),
                os.environ.get('<[app]>_MYSQL_DB')))
        if os.environ.get("<[app]>_ENV") == 'test':
